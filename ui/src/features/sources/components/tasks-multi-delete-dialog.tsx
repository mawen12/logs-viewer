...
type SourceMultiDeleteDialogProps<TData> = {
  open: boolean
...
export function SourcesMultiDeleteDialog<TData>({
  open,
  onOpenChange,
  table,
}: SourceMultiDeleteDialogProps<TData>) {
    ...
    <ConfirmDialog
      ...
      title={
        <span className='text-destructive'>
          ...
          {selectedRows.length > 1 ? 'sources' : 'source'}
        </span>
      }
      desc={
        <form
